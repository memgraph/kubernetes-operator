...
type normalizedSpec struct {
	...
	coordinatorStorage normalizedStorage
	dataStorage        normalizedStorage
}
...
func normalize(spec memgraphcomv1alpha1.MemgraphClusterSpec) normalizedSpec {
	n := normalizedSpec{
		...
		coordinatorStorage: normalizeStorage(spec.Storage.Coordinators),
		dataStorage:        normalizeStorage(spec.Storage.Data),
	}
